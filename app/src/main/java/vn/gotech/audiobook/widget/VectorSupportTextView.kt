...
open class VectorSupportTextView @JvmOverloads constructor(
    context: Context,
    ...
    private fun initAttrs(context: Context, attrs: AttributeSet?) {
        if (attrs != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                dStart =
                    attributeArray.getDrawable(R.styleable.VectorSupportTextView_drawableStartCompat)
                dEnd =
                    attributeArray.getDrawable(R.styleable.VectorSupportTextView_drawableEndCompat)
                dBottom =
                    attributeArray.getDrawable(R.styleable.VectorSupportTextView_drawableBottomCompat)
                dTop =
                    attributeArray.getDrawable(R.styleable.VectorSupportTextView_drawableTopCompat)
            } else {
                val drawableStartId = attributeArray.getResourceId(
                    R.styleable.VectorSupportTextView_drawableStartCompat,
                    0
                )
                val drawableEndId = attributeArray.getResourceId(
                    R.styleable.VectorSupportTextView_drawableEndCompat,
                    0
                )
                val drawableBottomId = attributeArray.getResourceId(
                    R.styleable.VectorSupportTextView_drawableBottomCompat,
                    0
                )
                val drawableTopId = attributeArray.getResourceId(
                    R.styleable.VectorSupportTextView_drawableTopCompat,
                    0
                )
            ...
            drawableStartSquareSize = attributeArray.getDimensionPixelSize(
                R.styleable.VectorSupportTextView_drawableStartSquareSize,
                -1
            )
            drawableEndSquareSize = attributeArray.getDimensionPixelSize(
                R.styleable.VectorSupportTextView_drawableEndSquareSize,
                -1
            )
            drawableBottomSquareSize = attributeArray.getDimensionPixelSize(
                R.styleable.VectorSupportTextView_drawableBottomSquareSize,
                -1
            )
            drawableTopSquareSize = attributeArray.getDimensionPixelSize(
                R.styleable.VectorSupportTextView_drawableTopSquareSize,
                -1
            )
            ...
            drawableTintColor =
                attributeArray.getColor(R.styleable.VectorSupportTextView_drawableTintCompat, -1)
