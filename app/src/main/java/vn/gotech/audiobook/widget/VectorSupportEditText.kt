...
open class VectorSupportEditText @JvmOverloads constructor(
    context: Context,
    ...
    private fun initAttrs(context: Context, attrs: AttributeSet?) {
        if (attrs != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                dStart =
                    attributeArray.getDrawable(R.styleable.VectorSupportEditText_supportDrawableStart)
                dEnd =
                    attributeArray.getDrawable(R.styleable.VectorSupportEditText_supportDrawableEnd)
                dBottom =
                    attributeArray.getDrawable(R.styleable.VectorSupportEditText_supportDrawableBottom)
                dTop =
                    attributeArray.getDrawable(R.styleable.VectorSupportEditText_supportDrawableTop)
            } else {
                val drawableStartId = attributeArray.getResourceId(
                    R.styleable.VectorSupportEditText_supportDrawableStart,
                    0
                )
                val drawableEndId = attributeArray.getResourceId(
                    R.styleable.VectorSupportEditText_supportDrawableEnd,
                    0
                )
                val drawableBottomId = attributeArray.getResourceId(
                    R.styleable.VectorSupportEditText_supportDrawableBottom,
                    0
                )
                val drawableTopId = attributeArray.getResourceId(
                    R.styleable.VectorSupportEditText_supportDrawableTop,
                    0
                )
            ...
            drawableStartSquareSize = attributeArray.getDimensionPixelSize(
                R.styleable.VectorSupportEditText_supportDrawableStartSquareSize,
                -1
            )
            drawableEndSquareSize = attributeArray.getDimensionPixelSize(
                R.styleable.VectorSupportEditText_supportDrawableEndSquareSize,
                -1
            )
            drawableBottomSquareSize = attributeArray.getDimensionPixelSize(
                R.styleable.VectorSupportEditText_supportDrawableBottomSquareSize,
                -1
            )
            drawableTopSquareSize = attributeArray.getDimensionPixelSize(
                R.styleable.VectorSupportEditText_supportDrawableTopSquareSize,
                -1
            )
