package vn.gotech.audiobook.widget.ahbottomnavigation;
...
import vn.gotech.audiobook.widget.ahbottomnavigation.notification.AHNotification;
import vn.gotech.audiobook.widget.ahbottomnavigation.notification.AHNotificationHelper;
...
public class AHBottomNavigation extends FrameLayout {
    ...
    private int notShowIndicatorPosition = -1;
    private int positionTabDefault = 0;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                showIndicator = ta.getBoolean(R.styleable.AHBottomNavigationBehavior_Params_inactiveColor, false);
    ...
    private int calculateHeight(int layoutHeight) {
        ...
        int[] attrs;
        attrs = new int[]{android.R.attr.fitsSystemWindows, android.R.attr.windowTranslucentNavigation};
    ...
    /**
     * Set the item position not show indicator
     *
     * @param position int
     */
    public void setPositionNotShowIndicator(int position) {
        this.notShowIndicatorPosition = position;
    }

    /**
     * Set thefirst  item position show indicator
     *
     * @param position int
     */
    public void setPositionTabDefaultIndicator(int position) {
        this.positionTabDefault = position;
    }
