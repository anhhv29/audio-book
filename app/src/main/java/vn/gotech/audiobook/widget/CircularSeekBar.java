...
public class CircularSeekBar extends View {
    ...
    protected static final float DEFAULT_CIRCLE_STROKE_WIDTH = -8f;
    ...
    protected void initAttributes(TypedArray attrArray) {
        ...
        mProgress = attrArray.getInt(R.styleable.CircularSeekBar_progress_default, DEFAULT_PROGRESS);
     ...
     *
     * @parambooleanvalue. True if user touch input is to be accepted, false if user touch input is to be ignored.
     */
